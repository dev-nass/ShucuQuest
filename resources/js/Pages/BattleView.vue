...
<template>
    <div class="min-h-screen bg-[#0C0F1A] flex flex-col px-6 py-12">
        ...
        <div class="text-center mb-8">
            <h1 class="text-white font-pixel text-2xl">Current Status: {{ status }}</h1>
        </div>

        <!-- Middle Section: Characters + Selected Letters -->
        <div class="flex-1 flex items-center justify-between px-24 mb-8 relative">
            <!-- Left Character Placeholder -->
            <div class="w-64 h-64 bg-[#0D1526] border-2 border-[#A855F7] flex items-center justify-center">
                <span class="text-[#A855F7] font-pixel text-sm">CHARACTER 1</span>
            </div>

            <!-- Selected Letters (Center - Absolute) -->
            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 grid grid-cols-6 gap-3">
            ...
            <div class="w-64 h-64 bg-[#0D1526] border-2 border-[#A855F7] flex items-center justify-center">
                <span class="text-[#A855F7] font-pixel text-sm">CHARACTER 2</span>
            </div>
        </div>
